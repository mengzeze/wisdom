    ...
    <div class="dynamicTask">
      ...
      <div class="infinite-list-wrapper">
        ...
        >
          ...
          <div ref="reference" id="observers_list">
            <li
              class="clearfix"
            ...
            >
              <span class="fl" ref="fl" @mouseleave="levesuspension(item,$event,index)">
                ...
                >
                  ...
                  <br />
                  <span @click="pointer_sc(item)" style="cursor: pointer;" class="color-primary">
                    <!-- 删除 -->
      ...
      <div style="position:relative;border: 1px solid #d9d9d9;padding-bottom:36px;">
        <div style="overflow: auto;" id="inner" :class="[forbiddenis == 4?'notclick':'']">
            <div
            ...
            <div class="edit-box-footer">
              <el-button size="medium" :class="[forbiddenis == 4?'notclick':'']" @click="empty()" type="text">清空</el-button>
              <el-button size="medium" :class="[forbiddenis == 4?'notclick':'']" type="text" @click="send()">发送</el-button>
            </div>
          </div>
      </div>
      <!-- <div class="dialog-footer" style="text-align:right;padding-top: 13px;">
        <el-button size="medium" :class="[forbiddenis == 4?'notclick':'']" @click="empty()">清空</el-button>
        <el-button size="medium" :class="[forbiddenis == 4?'notclick':'']" type="primary" @click="send()">发送</el-button>
      </div> -->
    </div>
  </div>
</template>
...
export default {
  name: "dynamic-task",
  props: ["dynamicData", "mbids", "Empty", "name",'forbiddenis'],
  data() {
    return {
      messages: "",
      obj: [],
    ...
    // console.log(spanhtm)
      this.$nextTick(() => {
        setTimeout(() => {
          ...
          var observers_list = document.getElementById("observers_list");
