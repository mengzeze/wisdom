                ...
                <div class="fl" style="width:114%;margin-left: 29px;">
                    <el-form  ref="formaddTask" style="text-align: left;padding-right: 18%;">
                        <el-form-item label="" :label-width="formLabelWidth">
                            ...
                            <el-input type="textarea" style="width: 91%;" resize='none' v-model="name"  maxlength="500" placeholder="请输入名称"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="任务提醒" :label-width="formLabelWidth">
                          ...
                          <el-form-item label="" :label-width="formLabelWidth">
                            <span style="float:left;margin-left: -19%;"><i style="color: red;">*</i>项目阶段</span>
                            <el-select v-model="value5"  @change="Prioritys" placeholder="请选择阶段">
                                <el-option
                       ...
                       <el-form-item label="优先级" :label-width="formLabelWidth">
                        ...
                        <el-form-item label="任务内容" :label-width="formLabelWidth">
                              <Editor :changes="changes" :html2="html2" @htmls2="htmls2" />
                    ...
                    <div slot="footer" class="dialog-footer" style="text-align:center;padding-right: 120px;">
                        ...
                        <el-button type="primary" id="project_task_add" @click="taskAdddiloag">创 建</el-button>
                     </div>
                </div>
            </div>
        </el-dialog>
      <!--:findUserObj="zxr == 1 ? findUserObj : findUserObjM"-->
      <select_box :findFlagShow.sync="flags" :findState="findState"
                    @findAllUser="findAllUser" :checkState="checkState" />
...
export default {
    props:["flagadd","addnew",'mrid','projectMsg'],
    components:{
        // select_box,
        select_box,
        Editor
    ...
    methods:{
        ...
        jds(){
            ...
            this.$post('/info/project/getImplementStageList', data).then((response)=> {
                ...
                // console.log(_this)
                // _this.projectMsg=response.data
        ...
        taskAdddiloag(){
            ...
            this.$post('/info/task/saveTask', data).then((response)=> {
                ...
                this.findUserObj = []
                this.findUserObjM = []
                _this.$emit('changeWindowadd',false)
                 var state={state:4}
