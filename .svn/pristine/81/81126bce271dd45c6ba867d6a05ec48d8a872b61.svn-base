...
<el-select v-model="filterText" @change="filterTexts" size="mini" filterable placeholder="请输入角色">
                      ...
                      <div class="wanc">
                        ...
                        <ul class="choTypes">
                            <li @click="roleNames(item)" class="clearfix" v-for="item in peodatas">
                    ...
                    <div class="typeRight fr">
                        ...
                        <div class="container">
                            <div class="containers">
                                <ul class="choTypes">
                                    <li   @mouseleave="leave" v-if="seen" class="clearfix" v-for="(item,index) in olarr">
                                        <span @mouseover="over(item)" class="fl">{{item.name}}</span>
...
<script>
  export default {
    data() {
     ...
     props:['peodatas','peostate','clearpeo','radioUser'],
     watch:{
         peodatas:function(newV){
            this.state_box=true
        },
