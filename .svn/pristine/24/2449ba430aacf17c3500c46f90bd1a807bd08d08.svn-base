<template>
  <div class="edit_container" :title="isTaskUser ? '' : '无对应权限，请联系对应项目组负责人处理'">
    ...
    <div id="editor00001" class="toolbar"></div>
    <div id="editor100111" class="text"></div>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    ...
    initContent(){
      ...
      this.editor = new E("#editor00001","#editor100111");
      ...
      if(this.isTaskUser){
        setTimeout(()=>{
          let ele = document.querySelectorAll('#editor100111 div')
          ele.forEach(obj=>{
