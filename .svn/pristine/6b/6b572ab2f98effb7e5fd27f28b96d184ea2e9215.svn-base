...
var SaveModelCtrl = [ '$rootScope', '$scope', '$http', '$route', '$location',
    ...
    $scope.save = function (successCallback) {
        ...
        var params = {
            data:{
                actModelId:modelMetaData.modelId,
                procName:$scope.saveDialog.name,
                procDescr:$scope.saveDialog.description,
                procSourceVo:encodeURIComponent(json),// 把字符串作为url组件进行编码
                procSourceExtraVo:encodeURIComponent(svgDOM)
            },
