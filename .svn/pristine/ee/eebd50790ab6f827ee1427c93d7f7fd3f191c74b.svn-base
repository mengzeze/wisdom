<template>
  <div class="myclientparents my-client">
    ...
    <div style="float:right" class="mr-10">
        ...
        <el-dropdown  @command="addNewCustom" class="ml-10"> 
            <el-button type="primary">
                <i class="el-icon-plus"></i>&nbsp;新增客户
            </el-button>
            <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command='medium'>新增融资客户</el-dropdown-item>
                <el-dropdown-item command='nature'>新增自然人客户</el-dropdown-item>
                <el-dropdown-item command='finance'>新增中介机构</el-dropdown-item>
            </el-dropdown-menu>
        </el-dropdown>
